              ...
              try {
                ...
                const emailRes = await fetch('https://api.resend.com/emails', {
                  ...
                  body: JSON.stringify({
                    from: emailFrom,
                    to: buyerEmail,
                    subject: 'Спасибо за регистрацию на курс «Мышление в эпоху ИИ»',
                    text: `Здравствуйте!

Спасибо за регистрацию на курс «Мышление в эпоху ИИ».

Он начнется 10 августа.

Для участия в программе, пожалуйста, присоединитесь к нашим Telegram-ресурсам.

Telegram-канал — здесь публикуются расписание, ссылки на встречи, домашние задания, дополнительные материалы и все организационные объявления:

https://t.me/+iPOnVU0xq_RlYzZi

Telegram-чат — пространство для общения участников и вопросов по программе:

https://t.me/+inJ2IYxm9Fs4NTli

Рекомендуем присоединиться к каналу и чату до начала программы, чтобы не пропустить первые сообщения.

Если у вас возникнут вопросы или сложности с доступом, пожалуйста, напишите нам в Telegram:
...
Команда курса «Мышление в эпоху ИИ»`,
                  }),
                });
